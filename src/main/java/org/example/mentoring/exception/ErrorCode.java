...
public enum ErrorCode {
    ...
    APPLICATION_NOT_BELONG_TO_MENTEE(HttpStatus.FORBIDDEN, "APPLICATION_006", "신청이 멘티의 것이 아닙니다."),
    ...
    SLOT_INVALID_TIME_RANGE(HttpStatus.BAD_REQUEST, "SLOT_006", "슬롯 시작 시간은 종료 시간보다 빨라야 합니다."),
    SLOT_START_AT_IN_PAST(HttpStatus.BAD_REQUEST, "SLOT_007", "과거 시작 시간으로 슬롯을 생성할 수 없습니다."),
    ...
    RESERVATION_PAYMENT_NOT_MARKED(HttpStatus.BAD_REQUEST, "RESERVATION_009", "멘티 입금 완료 표시가 먼저 필요합니다."),
